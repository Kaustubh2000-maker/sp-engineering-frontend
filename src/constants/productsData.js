import fireImg from "./../assets/other/fire/fire-12.webp";
...
export let productsdata = [
  {
    ...
    description: [
      ...
      "Our turnkey approach includes site assessment, customized system design, professional installation, regular maintenance, and prompt emergency response—guaranteeing complete fire safety coverage from planning to post-deployment support.",
    ],
    text: [
  ...
  },
  {
    ...
    description: [
      ...
      "We offer end-to-end services including site analysis, system design, installation, and maintenance for maximum efficiency and reliability.",
    ],
    text: [
  ...
  },
  {
    ...
    description: [
      ...
      "From design and installation to system integration and after-sales support, we deliver comprehensive HVAC services tailored to your building’s size, usage patterns, and environmental conditions—ensuring year-round comfort and regulatory compliance.",
    ],
    text: [
