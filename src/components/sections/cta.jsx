...
//                   </option>
//                   <option value="fire-protection">Solar</option>
//                   <option value="fire-protection">HVAC</option>
//                   <option value="fire-protection">Storage Tanks</option>
//                   <option value="fire-protection">EPCM</option>
//                   <option value="fire-protection">Fire Consultancy</option>
//                 </select>
//               </div>
...
//                 </label>
//                 <select name="service" className="cta-select">
//                   <option value="fire-protection">Nashik</option>
//                   <option value="fire-protection">Vadodara</option>
//                 </select>
//               </div>
